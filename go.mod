...
replace github.com/netbirdio/management-integrations/integrations => github.com/ValarMarkhulis/management-integrations-flow-enabled/integrations v0.0.0-20250714094303-759db8f0ff9f
