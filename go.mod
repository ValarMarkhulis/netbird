...
replace github.com/netbirdio/management-integrations/integrations => github.com/ValarMarkhulis/management-integrations-flow-enabled/integrations v0.0.0-20250712194622-8a405dfe6fac